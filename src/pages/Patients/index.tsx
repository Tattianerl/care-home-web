...
export function Patients() {
  ...
  const totalPages =
    Math.ceil(filteredAndSortedPatients.length / ITEMS_PER_PAGE) || 1;
    ...
    <div className="space-y-8 pb-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-0.5 text-xs font-medium text-slate-500">
              Gerencie e acompanhe os prontuários dos residentes
              cadastrados.
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        ...
        <button
          ...
          className="inline-flex cursor-pointer items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-3.5 py-2.5 text-xs font-semibold text-slate-700 shadow-xs transition-colors hover:bg-slate-50"
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-between border-t border-slate-200/80 pt-4">
              <span className="text-xs text-slate-500">
                ...
                ({filteredAndSortedPatients.length} residentes)
              </span>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="inline-flex cursor-pointer items-center gap-1 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-600 shadow-xs hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50"
                >
